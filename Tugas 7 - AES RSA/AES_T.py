...
def enc(key, data):
    ...
    pad = chr(16 - len(data) % 16)
    
    if len(pad) != 16:
        data += pad
    grids = hexing(break_in_grids_of_16(data))
...
pt = "aku adalah anak gemabal selalu riang serta gembira, karena aku rajin bekerja, tak perna malas, atau pun lengah"
key = "password12345678"
list_pt = hexing(break_in_grids_of_16(pt))
list_key = hexing(break_in_grids_of_16(key))
if(len(pt) % 16 != 0):
    rem = (len(pt) // 16) + 1
    # print(rem)
    lim = (16 * rem) - len(pt)
...
# print(list_pt)
# print(list_key)
# boxed = matrix2sbox(list_pt)
# print(boxed)
# print(shift_rows(boxed[0]))
# print(inv_shift_rows(boxed[0]))
# for i in range(len(list_pt)):
#     for j in range(len(list_pt[i])):
#         for k in range(len(list_pt[i][j])):
#             print(list_pt[i][j][k])            
# print(matrix2sbox_r(matrix2sbox(hexing(break_in_grids_of_16(pt)))))
# print(add_sub_key(list_pt[0], list_key[0]))
# print(list_pt[0][0][0])
# print(expand_key(key, 1))
# print(mix_columns(list_pt[0]))
# print(add_sub_key(list_pt[0], list_key[0]))
# print(31//16)
...
hasil = enc(key, pt)
print(hasil)
dek = dec("password12345678", hasil)
print(dek)
